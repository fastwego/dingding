...
func TestListIds(t *testing.T) {
	...
	var resp []byte
	test.MockSvrHandler.HandleFunc(apiListIds, func(w http.ResponseWriter, r *http.Request) {
		w.Write([]byte(resp))
	})
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			resp = mockResp[tt.name]
			gotResp, err := ListIds(tt.args.ctx, tt.args.params)
			//fmt.Println(string(gotResp), err)
			if (err != nil) != tt.wantErr {
			...
			if !reflect.DeepEqual(gotResp, tt.wantResp) {
				t.Errorf("ListIds() gotResp = %v, want %v", gotResp, tt.wantResp)
			}
		})
	}
}
...
func TestListParentDeptsByDept(t *testing.T) {
	...
	var resp []byte
	test.MockSvrHandler.HandleFunc(apiListParentDeptsByDept, func(w http.ResponseWriter, r *http.Request) {
		w.Write([]byte(resp))
	})
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			resp = mockResp[tt.name]
			gotResp, err := ListParentDeptsByDept(tt.args.ctx, tt.args.params)
			//fmt.Println(string(gotResp), err)
			if (err != nil) != tt.wantErr {
				t.Errorf("ListParentDeptsByDept() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(gotResp, tt.wantResp) {
				t.Errorf("ListParentDeptsByDept() gotResp = %v, want %v", gotResp, tt.wantResp)
			}
		})
	}
}
func TestListParentDepts(t *testing.T) {
	...
	var resp []byte
	test.MockSvrHandler.HandleFunc(apiListParentDepts, func(w http.ResponseWriter, r *http.Request) {
		w.Write([]byte(resp))
	})
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			resp = mockResp[tt.name]
			gotResp, err := ListParentDepts(tt.args.ctx, tt.args.params)
			//fmt.Println(string(gotResp), err)
			if (err != nil) != tt.wantErr {
				t.Errorf("ListParentDepts() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(gotResp, tt.wantResp) {
				t.Errorf("ListParentDepts() gotResp = %v, want %v", gotResp, tt.wantResp)
			}
		})
	}
}
